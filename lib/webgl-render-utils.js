...
function drawModel(gl, sp, model, params) {
  ...
  let Pmat = mat4.create();
	...
	mat4.translate(Mmat, [-cam.pos[0], -cam.pos[1], -cam.pos[2]])

	// transform
	mat4.translate(Mmat, [transform.pos[0], transform.pos[1], transform.pos[2]])
	...
	mat4.translate(Mmat, [pos[0], pos[1], pos[2]])
